...
const Input: FC<InputProps> = ({register, type, id, placeholder, name, lengthMin, lengthMax, errors, errorText=""}) => {
  return (
    <div>
        <input
            type={type}
            ...
            {...register(name, { required: true, minLength: lengthMin, maxLength: lengthMax })}
