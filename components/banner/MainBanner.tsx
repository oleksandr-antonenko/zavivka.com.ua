...
const MainBanner = ({forMen=false, haircut=false}: {forMen?: boolean, haircut?: boolean}) => {
    return(
        <section className="w-full relative">
            <div className="flex max-w-[1440px] 2xl:mx-auto flex-col justify-end w-full h-[800px]">
                <div className="font-banner text-2xl text-white pl-[27px] md:pl-[100px] xl:pl-[260px] 2xl:pl-5 pb-[60px]">
                    {!haircut && <h1 className="leading-[130%] text-[40px] md:text-7xl mb-10 font-bold text-center md:text-start">{forMen && <span>Чоловіча</span>} <span className={`${forMen ? "lowercase" : ""}`}>Завивка</span> <br className="hidden md:block"/> волосся в Києві</h1>}
                    {haircut && <h1 className="leading-[130%] text-[40px] md:text-7xl mb-10 font-bold text-center md:text-start">Стрижка природіх <br/> кучерів
                        в Києві</h1>}
