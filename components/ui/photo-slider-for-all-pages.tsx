...
import { variants } from '@/components/team/components/animation/animation-works-slider';
...
interface CurlPhotoSliderProps {
  photos: string[];
}

const PhotoSliderForAllPages = ({ photos }: CurlPhotoSliderProps) => {
...
export default PhotoSliderForAllPages;
