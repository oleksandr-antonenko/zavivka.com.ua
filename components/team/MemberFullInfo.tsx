...
const MemberFullInfo: FC<MemberFullProps> = ({ forMen = false, member }) => {
  return (
    <section className="relative">
      <div className="rounded-full -right-[300px] sm:-right-[200px] -top-[2px] w-[500px] h-[500px] md:w-[580px] md:h-[580px] xl:w-[600px] xl:h-[600px] absolute -z-10 bg-grey-middle" />
      {member && (
        <>
          <div
